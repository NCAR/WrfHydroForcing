...
outDir = "/glade/p/cisl/nwc/nwm_forcings/Forcing_Inputs/NAM_Nest_Hawaii"
...
errTitle = 'Error_get_NAM_Nest_HI'
warningTitle = 'Warning_get_NAM_Nest_HI'

pid = os.getpid()
lockFile = tmpDir + "/GET_NAM_Nest_HI.lock"
...
if os.path.isfile(lockFile):
	...
	warningMsg =  "WARNING: Another NAM Nest Hawaii Fetch Program Running. PID: " + pid
