        ...
        if self.number_supp_pcp > 0:
            ...
            for i,suppOpt in enumerate(self.supp_precip_forcings):
                if suppOpt < 0 or suppOpt > 7:
                    err_handler.err_out_screen('Please specify SuppForcing[i][\'Pcp\'] values between 1 and 7.')
...
def main():
    ...
    diff <(./config.py ../Test/template_forcing_engine_AnA_v2.yaml) <(./config_v1.py ../Test/template_forcing_engine_AnA_v2.config)
    """
    if len(sys.argv) < 2:
